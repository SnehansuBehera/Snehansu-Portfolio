        ...
        <div className='bg-gray-800 px-[4vw] xl:px-52 py-8 flex flex-col'>
            <div className=' py-4 flex gap-5 sm:gap-0 justify-between items-center border-b-[0.1rem] border-gray-500 pr-4'>
                ...
                <div className='flex items-center justify-center gap-4 sm:gap-8 md:gap-12'>
                    <Link href='/'><Image src='/linkedin-img.png' alt='socials' width={500} height={500} className='w-[1rem] sm:w-[1.2rem]' /></Link>
                    <Link href='/'><Image src='/github-img.png' alt='socials' width={500} height={500} className='w-[1rem] sm:w-[1.2rem]' /></Link>
                    <Link href='/'><Image src='/twitter-img.png' alt='socials' width={500} height={500} className='w-[1rem] sm:w-[1.2rem]' /></Link>
                    <Link href='/'><Image src='/email-img.png' alt='socials' width={500} height={500} className='w-[1rem] sm:w-[1.2rem]' /></Link>
                    <Link href='/'><Image src='/discord.png' alt='socials' width={500} height={500} className='w-[1rem] sm:w-[1.2rem]' /></Link>
                </div>
            </div>
