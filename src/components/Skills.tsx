...
const Skills = () => {
    return (
        <div className='bg-gray-800 max-w-[1100px] flex flex-col gap-8 mx-auto my-10 rounded-lg py-10 px-[2rem] sm:px-[4.3rem] text-white'>
            <h1 className={`${bebas.className} mx-auto text-[2rem] border-t-2 border-white w-[6.7rem]`}>TOP SKILLS</h1>
            <div className='flex flex-wrap items-center justify-center gap-6'>
                <Image src='/skills/CSS3_logo.png' alt='skills' width={500} height={500} className='w-[3rem] sm:w-[4rem]' />
                <Image src='/skills/javascript-logo.webp' alt='skills' width={500} height={500} className='w-[3rem] sm:w-[4rem]' />
